...
Actualmente no existe una definición matemáticamente formal de turbulencia. Luego, en ausencia de esta, se pueden presentar las principales características asociadas a los flujos turbulentos:
\begin{itemize*}
...
Para lograr la clausura de las ecuaciones filtradas, se necesita un modelo para el esfuerzo residual anisotrópico $\tau_{ij}^r$. El modelo más simple es el propuesto por \cite{doi:10.1175/1520-0493(1963)091<0099:GCEWTP>2.3.CO;2}, el cual también sirve como base para varios modelos más avanzados.
