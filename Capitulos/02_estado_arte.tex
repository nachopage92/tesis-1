...
\begin{figure}[h!]
	...
	\caption{Separación de escalas para la dinámica atmosférica. Fuente: Montornes et al. (2017) \cite{vortex2017}.}
...
\begin{figure}[h!]
	...
	\caption{Idealización de los distintos tamaños de vórtices dentro de un dominio en la zona gris de la turbulencia. Fuente: Montornes et al. (2017) \cite{vortex2017}.}
...
\begin{figure}[H]
	...
	\caption{Espectro de energía turbulenta multiescala. Fuente: Warner (2010) \cite{warner2010numerical}}
...
\begin{figure}[h!]
	...
	\caption{Comparación entre las coordenadas usuales sigma (arriba) y el método de frontera inmersa (abajo). Fuente: Arnold et al. (2010) \cite{Arnold2010}.}
