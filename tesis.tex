...
\title{``SISTEMA DE PREDICCIÓN DE VIENTO A CORTO PLAZO MEDIANTE SIMULACIONES MESO-MICROESCALA DE ALTA RESOLUCIÓN UTILIZANDO SIMULACIÓN DE GRANDES VÓRTICES Y ASIMILACIÓN DE DATOS EN CASOS REALES''}
\degree{Magíster en Ciencias de la Ingeniería Mecánica}
\supervisor{Dr. Ing. Alex Flores}
\correferent{Phd. Carlos Rosales}
