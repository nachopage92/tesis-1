...
\documentclass[oneside,spanish,a4paper]{ezthesis}
...
\title{SIMULACIÓN MULTIESCALA DEL VIENTO SOBRE TERRENO COMPLEJO MEDIANTE EL MÉTODO EMBEDIDO WRF-LES Y ASIMILACIÓN VARIACIONAL DE DATOS 4D}
\degree{Magíster en Ciencias de la Ingeniería Mecánica }
\supervisor{Dr. Ing. Alex Flores Maradiaga}
\correferent{Dr. Carlos Rosales Huerta}
...
\listoftables
%%%% Indice de tablas
\include{Capitulos/00_nomenclatura}
%
%%% # Cap'itulos #
